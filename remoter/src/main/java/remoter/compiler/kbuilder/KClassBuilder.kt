...
/**
 */
internal class KClassBuilder(element: Element, bindingManager: KBindingManager) :
...
//                                .addModifiers(KModifier.PRIVATE)
            ...
            .addProperty(
                PropertySpec.builder(
                    "remoteBinder", ClassName("android.os", "IBinder")
                        .copy(true)
                )
                    .mutable()
                    .addModifiers(KModifier.PRIVATE)
        ...
        stubClassBuilder.primaryConstructor(
            FunSpec.constructorBuilder()
                .addParameter(
                    ParameterSpec.builder(
                        "serviceImpl",
                        remoterInterfaceElement.asType().asTypeName().copy(true)
                    )
//                        .addModifiers(KModifier.PRIVATE)
                        .build()
                )
        ...
        TypeSpec.classBuilder("DeathRecipient")
            ...
            .primaryConstructor(
                FunSpec.constructorBuilder()
                    .addParameter(
                        ParameterSpec.builder(
                            "proxyListener", RemoterProxyListener::class.asTypeName()
                                .copy(nullable = true)
                        )
//                            .addModifiers(KModifier.PRIVATE)
                            .build()
            ...
            .addProperty(
                PropertySpec.builder(
                    "proxyListener", RemoterProxyListener::class.asTypeName().copy(nullable = true),
                    KModifier.PRIVATE
                )
                    .mutable()
